...
namespace Polystone.ViewModels
{
    public class MainWindowViewModel : BindableBase
    {
            ...
            IPolystoneServerService polystoneServerService)
        {
            ...
            // @todo not here but in account module
            _polystoneAccountService.SetAccount(
                _polystoneContextService.GetPolystoneContext().Accounts.FirstOrDefault(a_ => a_.Name == "Kawaakago")
            );

            var o = _polystoneAccountService.GetAccount();
